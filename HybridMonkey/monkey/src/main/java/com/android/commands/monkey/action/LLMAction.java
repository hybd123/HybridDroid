...
public class LLMAction extends Action {
    ...
    public LLMAction(ActionType type, ComponentName activity, Rect rect) {
        super(type);
    ...
    public LLMAction(ActionType type, ComponentName activity, List<PointF> points, Rect rect) {
        super(type);
        this.packageName = activity.getPackageName();
        this.className = activity.getClassName();
        this.boundingBox = rect;
    ...
    public LLMAction(ActionType type, String packageName, String className, Rect rect, String viewDesc) {
        super(type);
        this.type = type;
    ...
    public LLMAction setInputText(String str) {
        inputText = str;
        return this;
    }
    ...
    public LLMAction setUseAdbInput(boolean useAdbInput) {
    ...
    public LLMAction setEditText(boolean editText) {
        isEditText = editText;
        return this;
    }
